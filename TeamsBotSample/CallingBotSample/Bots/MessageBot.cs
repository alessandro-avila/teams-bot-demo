...
using CallingBotSample.Services.AgenticServices;
...
namespace CallingBotSample.Bots
{
    public class MessageBot : TeamsActivityHandler
    {
        ...
        private readonly OrleansSubscriberService subscriberService;
        ...
        public MessageBot(
            ...
            OrleansSubscriberService subscriberService)
        {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            else
            {
                ...
                subscriberService.AddConversationReference(userId, conversationReference);

                // Send the user's message to the dispatcher
                await dispatcherService.SendMessageAsync(userId, message);

                // Optionally acknowledge the user's message
                await turnContext.SendActivityAsync("I'm processing your message...", cancellationToken: cancellationToken);
