using CallingBotSample.OAgents.Attributes;
...
[DispatcherChoice("QnA", "The customer is asking a question related to internal Novartis knowledge base.", EventType.QnARequested)]
...
public class Dispatcher : AiAgent<DispatcherState>
{
    ...
    {
        var choices = GetType().GetCustomAttributes<DispatcherChoice>()
